...
####################################################### Header begin ################################################
dropout = [0.25, 0.3, 0.5, 0.5] #3,4,5,5
...
######################
#GD
learning_rate = settings.learning_rate #0.03549 #0.04049 #0.03049 #0.015 #0.07297 #0.09568# TODO 0.05  0.005 better, 0.001 good \0.02, 0.13799 to 0.14 good for 6 classes,
######################
#adam
beta1 = 0.9
beta2 = 0.999
