...
global summary_op
###############################
dropout = [0.45, 0.45, 0.5, 0.5, 0.5] #3,4,5,5
...
######################
#GD # good: 0.015 with 0.85 dropout
learning_rate = 0.0127 #0.03549 #0.04049 #0.03049 #0.015 #0.07297 #0.09568# TODO 0.05  0.005 better, 0.001 good \0.02, 0.13799 to 0.14 good for 6 classes,
######################
#adam
beta1 = 0.9
beta2 = 0.999
...
# 5x5 conv, 1 input, 8 outputs
    ...
    'wd1': tf.Variable(tf.random_normal([1 * 1 * conv4_out, n_hidden], stddev=0.1, seed=SEED), name="wd1"),
