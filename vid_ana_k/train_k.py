...
def read_clip_and_label_v2(filename, read_size, start_pos=-1, num_frames_per_clip=16, crop_size=112,
                           shuffle=False):
...
def train(MAX_ITERATION, learning_rate, model_path, model_name,log_LABEL, batch_size, momentum,num_of_clips_pro_class):
  ...
  '''
  CROP_SIZE, NUM_FRAMES_PER_CLIP = 112, 16
